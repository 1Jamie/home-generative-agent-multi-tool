...
from .agent.rag_embedding_text import strip_for_embedding, truncate_for_embedding_index
...
from .const import (
    ...
    HA_TOOL_GET_LIVE_CONTEXT,
    LANGCHAIN_LOGGING_LEVEL,
    SCHEMA_FIRST_YAML_PROMPT,
    SUBENTRY_TYPE_MODEL_PROVIDER,
    TOOL_CALL_ERROR_SYSTEM_MESSAGE,
)
from .core.assist_chat_log import (
    append_langgraph_turn_to_chat_log_from_delta_generator,
...
from .core.entity_index import gather_store_puts_in_chunks
from .core.langgraph_assist_stream import iter_merged_chat_log_deltas
from .core.subentry_resolver import get_tool_manager_subentry
...
class HGAConversationEntity(conversation.ConversationEntity, AbstractConversationAgent):
    ...
    async def _async_handle_message(  # noqa: C901, PLR0911, PLR0912, PLR0915
        ...
        # Fetch Tool Manager Config (prefer canonical unique_id if duplicates exist)
        tool_mgr_subentry = get_tool_manager_subentry(self.entry)
